...
HTML_CLEANER = Cleaner(
    style=True, remove_tags={"span", "br"}, safe_attrs=SAFE_ATTRS
)

MD_CONVERTER = Markdown(extensions=["mdx_linkify", "smarty", "tables"])
...
class CleanHTMLField(models.TextField):
    ...
    def from_db_value(self, value, *args, **kwargs):
        return mark_safe(MD_CONVERTER.convert(value))
